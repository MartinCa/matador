...
\begin{tikzpicture}
 ...
 \umlclass[x=2,y=0.5]{Player}{-carColor : int\\-name : String\\-konto : Konto\\-ownedFields : ArrayList<Ownable>\\-loser : bool}{+Player(String, int, int)\\+getName() : String\\+getCarColor() : int\\+getKonto() : Konto\\+buyField(Ownable)\\+getOwnedFields() : ArrayList<Ownable>\\+isLoser() : bool\\+setLoser()}
