...
\begin{tikzpicture}
 ...
 \umlclass[x=-5]{Game}{-activePlayer : int\\-winpoint : int\\-baeger : MatadorRafleBaeger}{+Game()\\-createPlayers(int)\\+startGame()\\-oneRound()\\-endRoundChecks()\\-showStatus(Field)\\-checkWinner()\\-gameEnd()\\-nextPlayer()}
 \umlclass[x=2]{Player}{-carColor : int\\-name : String\\-konto : Konto}{+Player(String, int, int)\\+getName() : String\\+getCarColor() : int\\+getKonto() : Konto}
 \umlclass[x=-5,y=-4.5]{Board}{}{+Board()\\-initBoard(int)\\+getField(int) : Field}
 \umlclass[y=-4.5,x=1,type=abstract]{Field}{\#name : String\\\#changeBalance : int\\\#fieldNum : int}{+Field(String, int)\\+Field(String, int, int)\\+getName() : String\\+getFieldNum() : int}
 ...
 \umlaggreg[arg2=-players,mult2=2]{Game}{Player}
