...
Dette pattern hænger meget tæt sammen med, og fremkommer af, begrebet "responsibility assignment". Det kan tolkes som "den der ved det, formidler det!". Indehaveren af en given information bliver altså tildelt ansvaret for også at videreformidle den. Et godt eksempel på anvendelse af \dpattern{Information Expert} kan findes i \klasse{Die}. Her er det oplagt at instanser af \klasse{Die} er eksperter på egne \textit{facevalues}. Dermed består "responsibility assignment", for \klasse{Die}, i metoder som \metode{getFaceValues} og \metode{rollDie}. 
